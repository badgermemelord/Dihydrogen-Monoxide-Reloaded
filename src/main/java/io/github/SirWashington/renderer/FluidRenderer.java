...
public class FluidRenderer {
    ...
    public static FluidRenderer getInstance(me.jellysquid.mods.sodium.client.render.pipeline.FluidRenderer renderer) {
        if (instance == null) {
            FluidRendererAccessor accessor = (FluidRendererAccessor) renderer;
            instance = new FluidRenderer(accessor.getLighters(), accessor.getColorBlender());
        }
        return instance;
    }
